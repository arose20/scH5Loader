            ...
            if isinstance(group, h5py.Group):
                ...
                if key == "X":
                    ...
                    for k in file["layers"].keys():
                        ...
                        layer_dict[k] = {
                            "group_keys": sub_group_keys,
                            "group_types": sub_group_types,
                        }
        ...
        if "group_keys" in value:
            ...
            if key == "X":
                ...
                for k, v in report["layers"]["sublayer_info"].items():
                    ...
                    print(
                        f"   Number of cells: {report['layers']['sublayer_info'][k]['Cell_num:']}"
                    )
                    print("")
...
def investigate_obs_columns_unique_contents(
    ...
    print(
        "\033[1mDataFrame output to see all unique values for each column of interest:\033[0m\n"
    )
    display(df)
